...
// 16. To find lowest the common ancestor.
...
void Postorder(BST *);
void search(BST *, int );
void findSmallest(BST *);
void findLargest(BST *);
void _deleteTree(BST *);
void deleteTree(BST **);
int countLeaf(BST *);
int countNodes(BST *);
int countNonLeafNodes(BST *);
int sumOfNodes(BST *);
int maxDepth(BST *);
void printCurrentLevel(BST *, int );
void printLevelOrder(BST *);
int isBSTUtil(BST *, int , int );
